                        ...
                        <div className="relative border-l border-gray-200 dark:border-gray-700 ml-3 space-y-8">
                            {activities.length === 0 ? (
                                ...
                                <div key={activity.id} className="relative ml-6">
                                    <span className="absolute -left-[31px] flex h-6 w-6 items-center justify-center rounded-full bg-blue-100 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-6">
                        ...
                        {tasks.length === 0 ? (
                            ...
                            <ul className="space-y-3">
                                {tasks.map(task => (
                                    <li key={task.id} className="flex items-center gap-3 p-3 rounded-lg border bg-gray-50 dark:bg-gray-800/50">
